...
Set unique keys in `~/.zcode/config.toml` and retry. \
See the zcode keymap documentation for supported actions and examples."
                    ));
                }
            }
        }
...
Set a different key in `~/.zcode/config.toml` and retry. \
See the zcode keymap documentation for supported actions and examples."
                ));
            }
        }
